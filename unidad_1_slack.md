...
1.  ##### Registro con correo. {#registro-con-correo}
...
1.  ##### Nombre del equipo de trabajo y del proyecto. {#nombre-del-equipo-de-trabajo-y-del-proyecto}
...
1.  ##### Invitación al espacio de trabajo de otros miembros del grupo de trabajo. {#invitaci-n-al-espacio-de-trabajo-de-otros-miembros-del-grupo-de-trabajo}
...
![](images/image76.png)Imagen 6\. Primeros pasos. Elaboración propia.
...
1.  Establece tu estado: en este apartado podremos especificar un estado de perfil. Entre las opciones nos indica, “En una reunión”, “De vacaciones”, etcétera.
...
1.  Perfil y Cuenta: Haciendo clic en este apartado nos aparecerá un menú en la parte derecha de nuestra pantalla. Si hacemos clic en “modificar perfil”, nos aparecerá una pantalla en la que podremos cambiar nuestro nombre; podemos poner el nombre de Slack (será el que aparecerá en nuestro perfil), podemos especificar qué hacemos (nuestro cargo o función); el teléfono, aunque no es obligatorio, y debemos seleccionar nuestra franja horaria de entre el desplegable.
...
1.  Preferencias. Volviendo al menú principal, el tercer apartado nos lleva a configurar las preferencias. En este apartado podremos cambiar muchos aspectos esenciales para el funcionamiento de la aplicación y del aspecto de la misma. En el menú lateral podemos ver que nos permite modificar apartados como:
...
1.  Cambiar a Ausente / Disponible. Es un atajo rápido para cambiar nuestro modo a la hora de estar trabajando en la plataforma.
2.  Ayudas y comentarios: apartado de ayuda para los usuarios a resolver dudas (FAQ).

### Capítulo 2\. La gestión del espacio de trabajo. {#cap-tulo-2-la-gesti-n-del-espacio-de-trabajo}
...
#### 2.1\. Conectarse a otro espacio de trabajo. {#2-1-conectarse-a-otro-espacio-de-trabajo}
...
#### 2\. 2\. La administración de un espacio de trabajo {#2-2-la-administraci-n-de-un-espacio-de-trabajo}
...
##### 2.2.3\. Autentificación. {#2-2-3-autentificaci-n}
...
#### Test de autoevaluación de Slack {#test-de-autoevaluaci-n-de-slack}